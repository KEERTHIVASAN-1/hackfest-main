...
export default function AccessDenied() {
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center relative overflow-hidden">
            ...
            <div className="text-center relative z-10 p-8 bg-white/80 backdrop-blur-sm rounded-xl shadow-xl shadow-secondary/5 border border-secondary/20">
                <ShieldAlert className="mx-auto h-24 w-24 text-red-500 drop-shadow-md" />
                ...
                <div className="mt-6">
                    <Link
                        to="/"
                        className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-black bg-secondary hover:bg-white hover:text-secondary hover:border-secondary transition-all duration-300 shadow-sm"
                    >
                        Go back home
                    </Link>
                </div>
