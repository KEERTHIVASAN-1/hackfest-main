                            ...
                            <div className="mt-1 relative">
                                <Listbox value={selectedRole} onChange={setSelectedRole}>
                                    <div className="relative mt-1">
                                        <Listbox.Button className="relative w-full cursor-default rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 text-left shadow-sm focus:border-secondary focus:outline-none focus:ring-1 focus:ring-secondary sm:text-sm text-gray-900">
                                            ...
                                            <Listbox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg shadow-secondary/10 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm border border-secondary/20">
                                                {ROLES.map((role, roleIdx) => (
                                                    <Listbox.Option
                                                        key={roleIdx}
                                                        className={({ active }) =>
                                                            `relative cursor-default select-none py-2 pl-10 pr-4 ${active ? 'bg-secondary/10 text-secondary' : 'text-gray-900'
                                                            }`
                                                        }
                                                        value={role}
                                                    >
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    className="block w-full appearance-none rounded-md border border-gray-300 bg-white px-3 py-2 placeholder-gray-400 text-gray-900 shadow-sm focus:border-secondary focus:outline-none focus:ring-secondary sm:text-sm"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                <input
                                    ...
                                    className="block w-full appearance-none rounded-md border border-gray-300 bg-white px-3 py-2 pr-10 placeholder-gray-400 text-gray-900 shadow-sm focus:border-secondary focus:outline-none focus:ring-secondary sm:text-sm"
                                />
                                <button
                                    type="button"
